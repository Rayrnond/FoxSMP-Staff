...
//Example: ItemStack is = new ItemBuilder(Material.DIAMOND_SWORD, 32).setDisplayName(ChatColor.BLUE+"This is a diamond sword").setLore("Hello", "I am", "A diamond", "sword").setInfinityDurability().addEnchant(Enchantment.PROTECTION_ENVIROMENTAL, 7).build();
public class ItemBuilder {
     ...
     * @return ItemBuilder instance with durability
     */
...
//    public ItemBuilder setSkullTexture(String texture, String signature) {
//        is.setType(Material.LEGACY_SKULL_ITEM);
...
//    }
    ...
    public ItemBuilder setLore(String lore){
        ...
        if (str[0] == null) arrayList.add(lore);
        else arrayList.addAll(Arrays.asList(str));
